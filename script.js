...
function createMatrixRain() {
    ...
    for (let i = 0; i < columnCount; i++) {
        ...
        text.style.animation = `matrixFall ${5 + Math.random() * 10}s linear infinite`;
...
class TerminalSimulator {
    constructor() {
        ...
        this.commands = {
            ...
            system: 'Linux morpheus 5.15.0-matrix #1 SMP x86_64 GNU/Linux\nProcessor: Neural Interface mk7\nMemory: ∞ GB\nReality: Simulated',
...
function initStripe() {
    ...
    if (stripeButton) {
        stripeButton.addEventListener('click', () => {
            ...
            alert('Stripe integration ready! Replace the payment link in the code with your actual Stripe Payment Link.');
...
document.addEventListener('click', (e) => {
    if (e.target.tagName === 'BUTTON' || e.target.classList.contains('docs-button')) {
